// Inline SVG icons — replaces all emoji usage

export function TomatoIcon({ size = 14, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <circle cx="12" cy="13" r="9" fill="var(--red)" opacity="0.85"/>
      <path d="M12 4C10 4 9 2 9 2s1 2 3 2 3-2 3-2-1 2-3 2z" fill="var(--green)"/>
    </svg>
  );
}
...
export function SubfolderIcon({ size = 14, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M20 20a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2h4l2 2h4a2 2 0 0 1 2 2z"/>
      <path d="M4 16V4a2 2 0 0 1 2-2h5l2 3h5"/>
    </svg>
  );
}
...
export function FlameIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="var(--yellow)" stroke="var(--yellow)" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
export function ChevronIcon({ size = 12, direction = 'right' }: { size?: number; direction?: 'right' | 'down' }) {
  return (
    <svg
      ...
      style={{ transform: direction === 'down' ? 'rotate(90deg)' : 'none', transition: 'transform 0.15s' }}
    >
...
export function GoalIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
